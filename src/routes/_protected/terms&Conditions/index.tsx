        ...
        <>
            <div className="min-h-screen bg-[#091B33] relative">
                <div className="sticky top-0">
                    <TopNavbar title={"Terms & Conditions"} />
                </div>
                <div className="flex flex-col items-start justify-center gap-5 px-5 text-white py-4 text-lg">
                    <p>
                        These terms and conditions apply to the <strong>PLAY124 app</strong> (hereby referred to as
                        "Application") for mobile devices, created by <strong>Service Provider</strong> as a Free
                        service.
                    </p>
                    <p>
                        Upon downloading or utilizing the Application, you are automatically agreeing to the following
                        terms. Unauthorized copying, modification, or attempts to extract the source code are strictly
                        prohibited. Intellectual property rights remain with the Service Provider.
                    </p>
                    <p>
