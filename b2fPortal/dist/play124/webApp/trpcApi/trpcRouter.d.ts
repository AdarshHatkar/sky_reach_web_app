...
export { router as play124WebAppTrpcRestRouter };
export declare const play124WebAppTrpcRouter: import("@trpc/server").CreateRouterInner<import("@trpc/server").RootConfig<{
    ctx: object;
    meta: object;
    errorShape: never;
    ...
    auth: import("@trpc/server").CreateRouterInner<import("@trpc/server").RootConfig<{
        ...
        register: import("@trpc/server").BuildProcedure<"mutation", {
            ...
            _meta: object;
            _ctx_out: {
                mysqlDB: import("../../../../prisma/play124/generatedClient/index.js").PrismaClient<{
                    transactionOptions: {
                        isolationLevel: "Serializable";
                    };
                }, never, import("../../../../prisma/play124/generatedClient/runtime/library.js").DefaultArgs>;
                play124: Required<{
                    appSlug?: string;
                    appId?: number;
                }>;
    ...
    games: import("@trpc/server").CreateRouterInner<import("@trpc/server").RootConfig<{
        ...
        challenges: import("@trpc/server").CreateRouterInner<import("@trpc/server").RootConfig<{
            ...
            getActiveChallenges: import("@trpc/server").BuildProcedure<"query", {
                ...
                result?: {
                    ...
                    status: import("../../../../prisma/play124/generatedClient/index.js").$Enums.ga_challenges_status;
                    challengeId: number;
                    gameId: number;
                    ...
                    prizeAmount: number;
                    creatorId: number;
                    creatorResult: import("../../../../prisma/play124/generatedClient/index.js").$Enums.ga_challenges_creatorResult;
                    creatorResultFileStoreId: number;
                    accepterId: number;
                    accepterResult: import("../../../../prisma/play124/generatedClient/index.js").$Enums.ga_challenges_accepterResult;
        ...
        contests: import("@trpc/server").CreateRouterInner<import("@trpc/server").RootConfig<{
                ...
                getUpcomingContests: import("@trpc/server").BuildProcedure<"query", {
                    ...
                    result?: {
                        ...
                        ga_file_store: {
                            ...
                            fileStoreId: number;
                            fileName: string;
                            fileCategory: import("../../../../prisma/play124/generatedClient/index.js").$Enums.ga_file_store_fileCategory;
                            sizeInBytes: number;
                            fileUrl: string;
                        };
                        _count: {
                        ...
                        status: import("../../../../prisma/play124/generatedClient/index.js").$Enums.ga_contests_status;
                        map: string;
                        gameId: number;
                        entryPerPlayer: number;
                        contestId: number;
            ...
            getRules: import("@trpc/server").BuildProcedure<"query", {
                _config: import("@trpc/server").RootConfig<{
                    ctx: object;
                    meta: object;
                    errorShape: never;
        ...
        getGames: import("@trpc/server").BuildProcedure<"query", {
            ...
            result?: {
                contestGames: {
                    ...
                    thumbnailFileStoreId: number;
                    gameName: string;
                    gameType: import("../../../../prisma/play124/generatedClient/index.js").$Enums.ga_games_gameType;
                }[];
                challengeGames: {
                    ga_file_store: {
                        updatedAt: number;
        ...
        getSuperGames: import("@trpc/server").BuildProcedure<"query", {
            _config: import("@trpc/server").RootConfig<{
                ctx: object;
                meta: object;
                errorShape: never;
            ...
            result?: {
                ...
                createdAt: number;
                thumbnailFileStoreId: number;
                superGameName: string;
            }[];
        }>;
        getChallengeGames: import("@trpc/server").BuildProcedure<"query", {
            _config: import("@trpc/server").RootConfig<{
                ctx: object;
                meta: object;
                errorShape: never;
        ...
        getContestGames: import("@trpc/server").BuildProcedure<"query", {
            _config: import("@trpc/server").RootConfig<{
                ctx: object;
                meta: object;
                errorShape: never;
    ...
    user: import("@trpc/server").CreateRouterInner<import("@trpc/server").RootConfig<{
        ...
        profile: import("@trpc/server").CreateRouterInner<import("@trpc/server").RootConfig<{
            ...
            updateProfile: import("@trpc/server").BuildProcedure<"mutation", {
                ...
                result?: {
                    ...
                    lastName: string;
                    username: string;
                    status: import("../../../../prisma/play124/generatedClient/index.js").$Enums.ga_users_status;
                    countryCode: string;
                    mobileNumber: string;
                    email: string;
                    profileFileStoreId: number;
        ...
        wallet: import("@trpc/server").CreateRouterInner<import("@trpc/server").RootConfig<{
            ...
            getWalletDetails: import("@trpc/server").BuildProcedure<"query", {
                ...
                message: string;
                result?: {
                    activePgName: import("../../../../prisma/play124/generatedClient/index.js").$Enums.ga_payment_gateways_activePgName;
                    depositWallet: number;
                    winWallet: number;
                    bonusWallet: number;
                    totalBalance: number;
                    ...
                    withdrawalMethods: {
                        ...
                        methodType: import("../../../../prisma/play124/generatedClient/index.js").$Enums.ga_withdrawal_methods_methodType;
                    }[];
                };
            }>;
            getWalletHistory: import("@trpc/server").BuildProcedure<"query", {
                ...
                result?: {
                    ...
                    walletType: import("../../../../prisma/play124/generatedClient/index.js").$Enums.ga_user_wallet_transactions_walletType;
                    transactionType: import("../../../../prisma/play124/generatedClient/index.js").$Enums.ga_user_wallet_transactions_transactionType;
                    newBalance: number;
                    description: string;
                }[];
            }>;
            ...
            submitDepositRequest: import("@trpc/server").BuildProcedure<"mutation", {
                ...
                result?: {
                    ...
                    pgName: import("../../../../prisma/play124/generatedClient/index.js").$Enums.ga_deposit_requests_pgName;
                    paymentUrl: any;
                };
            }>;
            submitWithdrawalRequest: import("@trpc/server").BuildProcedure<"mutation", {
                ...
                message: string;
                result?: {
                    status: import("../../../../prisma/play124/generatedClient/index.js").$Enums.ga_withdrawal_requests_status;
                    amount: number;
                    methodName: string;
                    methodId: string;
                    userId: number;
            ...
            getDepositHistory: import("@trpc/server").BuildProcedure<"query", {
                ...
                message: string;
                result?: {
                    status: import("../../../../prisma/play124/generatedClient/index.js").$Enums.ga_deposit_requests_status;
                    proofFileStoreId: number;
                    amount: number;
                    pgName: import("../../../../prisma/play124/generatedClient/index.js").$Enums.ga_deposit_requests_pgName;
                    userId: number;
    ...
    referAndEarn: import("@trpc/server").CreateRouterInner<import("@trpc/server").RootConfig<{
        ...
        getConfigs: import("@trpc/server").BuildProcedure<"query", {
            ...
            message: string;
            result?: {
                referRewardWallet: import("../../../../prisma/play124/generatedClient/index.js").$Enums.ga_user_refer_configs_referRewardWallet;
                referRewardAmount: number;
                registerBonusWallet: import("../../../../prisma/play124/generatedClient/index.js").$Enums.ga_user_refer_configs_registerBonusWallet;
...
export type webAppTrpcRouterTypes = typeof play124WebAppTrpcRouter;
